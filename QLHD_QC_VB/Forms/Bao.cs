...
namespace QLHD_QC_VB.Forms
{
    public partial class frmbao : Form
    {
        ...
        private void load_data()
        {
            ...
            dgvBao.DataSource = tblbao;
            dgvBao.Columns[0].HeaderText = "Mã báo";
            dgvBao.Columns[1].HeaderText = "Tên báo";
            dgvBao.Columns[2].HeaderText = "Địa chỉ";
            dgvBao.Columns[3].HeaderText = "Số điện thoại";
            dgvBao.Columns[4].HeaderText = "Email";
            dgvBao.Columns[0].Width = 75;
            dgvBao.Columns[1].Width = 175;
            dgvBao.Columns[2].Width = 400;
            dgvBao.Columns[3].Width = 100;
            dgvBao.Columns[4].Width = 200;
            dgvBao.AllowUserToAddRows = false;
            dgvBao.EditMode = DataGridViewEditMode.EditProgrammatically;
        }
        ...
        private void DataGridView_Click(object sender, EventArgs e)
        {
            ...
            txtmabao.Text = dgvBao.CurrentRow.Cells["mabao"].Value.ToString();
            txttenbao.Text = dgvBao.CurrentRow.Cells["tenbao"].Value.ToString();
            txtdiachi.Text = dgvBao.CurrentRow.Cells["diachi"].Value.ToString();
            txtemail.Text = dgvBao.CurrentRow.Cells["email"].Value.ToString();
            mskdienthoai.Text = dgvBao.CurrentRow.Cells["sdt"].Value.ToString();
            btnsua.Enabled = true;
            btnxoa.Enabled = true;
            btnlammoi.Enabled = true;
        ...
        private void frmbao_Load_1(object sender, EventArgs e)
        {
