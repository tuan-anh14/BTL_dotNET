...
namespace QLHD_QC_VB.Forms
{
    public partial class frmtimkiemkh : Form
    {
        ...
        {
            string sql;
            if ((txtmakh.Text == "") && (txtdiachi.Text == "") && (txttenkh.Text == "") && (txtsdt.Text == "") && (txtemail.Text == "") && (cbolvhd.SelectedValue == null))
            {
            ...
            if (txtsdt.Text != "")
            {
                sql = sql + " and dienthoai like N'%" + txtsdt.Text + "%'";
            }
            if (txtemail.Text != "")
            {
                sql = sql + " and email like N'%" + txtemail.Text + "%'";
            }
